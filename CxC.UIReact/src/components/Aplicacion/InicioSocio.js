...
class InicioSocio extends Component {
  // Carga el contexto
  ...
  renderRedirect = () => {
    ...
    if (this.state.redirect) {
      this.state.idAccion === "1" ? ruta = this.urlInstalacion + "/inicio"
      : this.state.idAccion==="2" ? ruta = this.urlInstalacion + "/inicio/editar"
      : this.state.idAccion==="3" ? ruta = this.urlInstalacion + "/inicio/renovar"
      : this.state.idAccion==="4" ? ruta = this.urlInstalacion + "/inicio/nueva"
      : ruta = ""
      //return <Redirect to='/editar' />
      return <Redirect
            to={{
              // pathname: this.state.idAccion==="1"?"/inicio":this.state.idAccion==="2"?"/inicio/editar":this.state.idAccion==="3"?"/inicio/renovar":this.state.idAccion==="4"?"/inicio/nueva":"",
              pathname: ruta,
              search: "",
          ...
          <div>
            ...
            {!this.state.MuestreConsultaVencimiento?
                <div className="contenedor">
                    <div className="DatosSocio row">
                      <DatosSocio />
                    </div>

                  <nav className="navbar navbar-default" role="navigation">
                      <div className="navbar-heade1r">
                          <h1 className="navbar-brand">Cuentas por Cobrar <span style={{color: "red"}}>activas</span></h1>
                      </div> 
