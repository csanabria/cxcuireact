...
{
    public class SocioTipoController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Session["usuarioLogueado"] != null)
            {
                ...
                var lista = NEGOCIO_SocioTipo.NEGOCIO_SelectAll().ToList();
                return View(lista);
            }
            else
            {
        ...
        [HttpPost]
        public ActionResult Create(FCCxCSocioTipo obj)
        {
            if (ModelState.IsValid)
            {
                var res = NEGOCIO_SocioTipo.NEGOCIO_insertar(obj);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var obj = NEGOCIO_SocioTipo.NEGOCIO_SelectAll().ToList().FirstOrDefault(a => a.IdTipoDeudor  == id);
            if (obj == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Edit([Bind(Include = "IdTipoDeudor,DscTipoDeudor")] FCCxCSocioTipo obj)
        {
 
            var res = NEGOCIO_SocioTipo.NEGOCIO_update(obj);
            if (ModelState.IsValid)
            {
                return RedirectToAction("Index");
            }
        ...
        {
            var obj = NEGOCIO_SocioTipo.NEGOCIO_SelectAll().ToList().FirstOrDefault(a => a.IdTipoDeudor  == id);
            var res = NEGOCIO_SocioTipo.NEGOCIO_delete(obj);
            return RedirectToAction("Index");
        }
    }
}