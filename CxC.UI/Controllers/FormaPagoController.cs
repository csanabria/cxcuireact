...
namespace CxC.UI.Controllers
{
    public class FormaPagoController : Controller
    {
        ...
        //    {
        //        lts.Add(new SelectListItem { Text = row.DscEstadoPago , Value = row.IdEstadoPago.ToString() });
        //    }
        //    return lts;
        //}
        List<SelectListItem> codigoEstado = new List<SelectListItem>
        {
        ...
        public ActionResult Index()
        {
            ...
            if (Session["usuarioLogueado"] != null)
            {
                ...
                var lista = NEGOCIO_FormaPago.NEGOCIO_SelectAll().ToList();
                return View(lista);
            }
            else
            {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "IdFormaPago,DscFormaPago,CodEstado")] FCCxCFormaPago obj)
        {
            var res = NEGOCIO_FormaPago.NEGOCIO_insertar(obj);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var obj = NEGOCIO_FormaPago.NEGOCIO_SelectAll().ToList().FirstOrDefault(a => a.IdFormaPago == id);
            if (obj == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Edit([Bind(Include = "IdFormaPago,DscFormaPago,CodEstado")] FCCxCFormaPago obj)
        {
            //var res = NEGOCIO_FCCxCFormaPago.NEGOCIO_update(obj);
            //return RedirectToAction("Index");
            var res = NEGOCIO_FormaPago.NEGOCIO_update(obj);
        ...
        // POST: FCCxCFormaPagos/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id)
        {
            var obj = NEGOCIO_FormaPago.NEGOCIO_SelectAll().ToList().FirstOrDefault(a => a.IdFormaPago == id);
            var res = NEGOCIO_FormaPago.NEGOCIO_delete(obj);
            return RedirectToAction("Index");
        }
    }
}