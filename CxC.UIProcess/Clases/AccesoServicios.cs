...
using CxC.UIProcess.WCF_Seguridad;


namespace CxC.UIProcess.Clases
{
    public class AccesoSeguridad
    {
        ...
        TEC_IWCF_SeguridadClient WCF_Seguridad = new TEC_IWCF_SeguridadClient();
        TEC_Credenciales SegCredenciales = new TEC_Credenciales();
        ...
        /// <returns></returns>
        public  TEC_MensajeOfTEC_Usuario ConsultarUsuario (int idUsuarioConsultar, string correoElectronico,
        ...
        /// <param name="ipAddress"></param>
        /// <returns></returns>
        public  TEC_MensajeOfTEC_Usuario AutenticarUsuario(string correoElectronico, string contrasena,
            int idUsuarioLogueado, string nombreUsuarioLogueado, string ipAddress, string sessionId)
        {
            SegCredenciales.CodigoAplicacionLogueado =
                Convert.ToInt32((ConfigurationManager.AppSettings["CodigoAplicacionLogueado"]));
        ...
        /// <returns></returns>
        public  TEC_MensajeOfListOfTEC_Permiso ConsultarPermisosUsuario(int idRol, int idUsuario, int idPadre, int idPermiso, int idUsuarioLogueado, string usuarioLogueado, string ipAddress, string sessionId)
        {
        ...
        /// <param name="ipAddress"></param>
        /// <returns></returns>
        public  TEC_MensajeOfListOfTEC_Bitacora ConsultarBitacoraGeneral(int idBitacora, int idTipoMovimiento, int idAplicacion, string usuarioCreacion, bool? esError, string ipOrigen, DateTime? fechaCreacion, int idUsuarioLogueado, string usuarioLogueado, string ipAddress, string sessionId, DateTime? fechaFin)
        {
            SegCredenciales.CodigoAplicacionLogueado = Convert.ToInt32((ConfigurationManager.AppSettings["CodigoAplicacionLogueado"]));
            SegCredenciales.UsuarioAplicacionLogueado = ConfigurationManager.AppSettings["UsuarioAplicacionLogueado"];
            SegCredenciales.ContrasenaUsuarioAplicacionLogueado = ConfigurationManager.AppSettings["ContrasenaUsuarioAplicacionLogueado"];
        ...
        #region Usuarios
        public TEC_MensajeOfListOfTEC_MovimientoUsuario ConsultarBitacoraUsuarios(int idMovimientoUsuario, int idTipoMovimiento, int idUsuario, string usuarioCreacion, DateTime? fechaCreacion, string idSession, string ipOrigen, string macAddress, int idUsuarioLogueado, string usuarioLogueado, string ipAddress, string sessionId, DateTime? fechaFin)
        {
            SegCredenciales.CodigoAplicacionLogueado = Convert.ToInt32((ConfigurationManager.AppSettings["CodigoAplicacionLogueado"]));
            SegCredenciales.UsuarioAplicacionLogueado = ConfigurationManager.AppSettings["UsuarioAplicacionLogueado"];
            SegCredenciales.ContrasenaUsuarioAplicacionLogueado = ConfigurationManager.AppSettings["ContrasenaUsuarioAplicacionLogueado"];
